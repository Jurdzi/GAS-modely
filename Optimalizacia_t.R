...
for (i in 0:11) {
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(-1,-20,0), 
                         upper =  c(1,1,10), control = DEoptim.control(
                           CR = 0.8,F = 1.2, 
                           itermax = 200, strategy = 1, c = 0.2,
                           parallelType = 1,
                           cluster = cl,
                           parVar = c("opt_data","uncond_t", "SP500_data")))
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(rep(0,3), rep(0,3)), 
                         upper =  c(rep(1,3), rep(0.99999,3)), control = DEoptim.control(
                           ...
                           parVar = c("gas_model","score_t","SP500_data", "ginv_2","opt_data","start_p")))
...
for (i in 0:11) {
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(-1,-20,0), 
                         upper =  c(1,1,10), control = DEoptim.control(
                           ...
                           parallelType = 1,
                           cluster = cl,
                           parVar = c("opt_data","uncond_t", "gold_data")))
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(rep(0,3), rep(0,3)), 
                         upper =  c(rep(1,3), rep(0.99999,3)), control = DEoptim.control(
                           ...
                           cluster = cl,
                           packages = c("mvnfast","rlist","tidyr","tidyverse","reshape2","MASS"),
                           parVar = c("gas_model","score_t","gold_data", "ginv_2","opt_data","start_p")))
...
for (i in 5:20) {
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(-1,-20,0), 
                         upper =  c(1,1,10), control = DEoptim.control(
                           ...
                           parallelType = 1,
                           cluster = cl,
                           parVar = c("opt_data","uncond_t", "btc_data")))
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(rep(0,3), rep(0,3)), 
                         upper =  c(rep(1,3), rep(0.99999,3)), control = DEoptim.control(
                           ...
                           cluster = cl,
                           packages = c("mvnfast","rlist","tidyr","tidyverse","reshape2","MASS"),
                           parVar = c("gas_model","score_t","btc_data", "ginv_2","opt_data","start_p")))
...
for (i in 0:12) {
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(-1,-20,0), 
                         upper =  c(1,1,10), control = DEoptim.control(
                           ...
                           parallelType = 1,
                           cluster = cl,
                           parVar = c("opt_data","uncond_t", "eurusd_data")))
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(rep(0,3), rep(0,3)), 
                         upper =  c(rep(1,3), rep(0.99999,3)), control = DEoptim.control(
                           ...
                           cluster = cl,
                           packages = c("mvnfast","rlist","tidyr","tidyverse","reshape2","MASS"),
                           parVar = c("gas_model","score_t","eurusd_data", "ginv_2","opt_data","start_p")))
...
for (i in 0:11) {
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(-1,-20,0), 
                         upper =  c(1,1,10), control = DEoptim.control(
                           ...
                           parallelType = 1,
                           cluster = cl,
                           parVar = c("opt_data","uncond_t", "bonds_data")))
  ...
  de_opt_norm <- DEoptim(fn = opt_fun, lower = c(rep(0,3), rep(0,3)), 
                         upper =  c(rep(1,3), rep(0.99999,3)), control = DEoptim.control(
                           ...
                           cluster = cl,
                           packages = c("mvnfast","rlist","tidyr","tidyverse","reshape2","MASS"),
                           parVar = c("gas_model","score_t","bonds_data", "ginv_2","opt_data","start_p")))
