...
#SP500
#5%
SP500_5 <- test_VaR(data = par_mat_SP500, quantile_func = qAST, percentile = 0.05)
...
SP500_2.5 <- test_VaR(data = par_mat_SP500, quantile_func = qAST, percentile = 0.025)
...
SP500_1 <- test_VaR(data = par_mat_SP500, quantile_func = qAST, percentile = 0.01)
...
#95%
SP500_95 <- test_VaR(data = par_mat_SP500, quantile_func = qAST, percentile = 0.95)
...
#97.5%
SP500_97.5 <- test_VaR(data = par_mat_SP500, quantile_func = qAST, percentile = 0.975)
...
#99%
SP500_99 <- test_VaR(data = par_mat_SP500, quantile_func = qAST, percentile = 0.99)
...
#gold
#5%
gold_5 <- test_VaR(data = par_mat_gold, quantile_func = qAST, percentile = 0.05)
...
gold_2.5 <- test_VaR(data = par_mat_gold, quantile_func = qAST, percentile = 0.025)
...
gold_1 <- test_VaR(data = par_mat_gold, quantile_func = qAST, percentile = 0.01)
...
#95%
gold_95 <- test_VaR(data = par_mat_gold, quantile_func = qAST, percentile = 0.95)
...
#97.5%
gold_97.5 <- test_VaR(data = par_mat_gold, quantile_func = qAST, percentile = 0.975)
...
#99%
gold_99 <- test_VaR(data = par_mat_gold, quantile_func = qAST, percentile = 0.99)
...
#btc
#5%
btc_5 <- test_VaR(data = par_mat_btc, quantile_func = qAST, percentile = 0.05)
...
btc_2.5 <- test_VaR(data = par_mat_btc, quantile_func = qAST, percentile = 0.025)
...
btc_1 <- test_VaR(data = par_mat_btc, quantile_func = qAST, percentile = 0.01)
...
#95%
btc_95 <- test_VaR(data = par_mat_btc, quantile_func = qAST, percentile = 0.95)
...
#97.5%
btc_97.5 <- test_VaR(data = par_mat_btc, quantile_func = qAST, percentile = 0.975)
...
#99%
btc_99 <- test_VaR(data = par_mat_btc, quantile_func = qAST, percentile = 0.99)
...
#eurusd
#5%
eurusd_5 <- test_VaR(data = par_mat_eurusd, quantile_func = qAST, percentile = 0.05)
...
eurusd_2.5 <- test_VaR(data = par_mat_eurusd, quantile_func = qAST, percentile = 0.025)
...
eurusd_1 <- test_VaR(data = par_mat_eurusd, quantile_func = qAST, percentile = 0.01)
...
#95%
eurusd_95 <- test_VaR(data = par_mat_eurusd, quantile_func = qAST, percentile = 0.95)
...
#97.5%
eurusd_97.5 <- test_VaR(data = par_mat_eurusd, quantile_func = qAST, percentile = 0.975)
...
#99%
eurusd_99 <- test_VaR(data = par_mat_eurusd, quantile_func = qAST, percentile = 0.99)
...
#bonds
#5%
bonds_5 <- test_VaR(data = par_mat_bonds, quantile_func = qAST, percentile = 0.05)
...
bonds_2.5 <- test_VaR(data = par_mat_bonds, quantile_func = qAST, percentile = 0.025)
...
bonds_1 <- test_VaR(data = par_mat_bonds, quantile_func = qAST, percentile = 0.01)
...
#95%
bonds_95 <- test_VaR(data = par_mat_bonds, quantile_func = qAST, percentile = 0.95)
...
#97.5%
bonds_97.5 <- test_VaR(data = par_mat_bonds, quantile_func = qAST, percentile = 0.975)
...
#test presiel
loss_bonds_97.5 <- LossVaR(realized = par_mat_bonds[1,], evaluated = bonds_97.5$quantile, tau = 0.005)
mean(loss_bonds_97.5)

#99%
bonds_99 <- test_VaR(data = par_mat_bonds, quantile_func = qAST, percentile = 0.99)
